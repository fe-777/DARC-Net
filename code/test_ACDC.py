...
parser.add_argument('--root_path', type=str, default='/root/autodl-fs/BCP-main/data/ACDC', help='Name of Experiment')
parser.add_argument('--exp', type=str, default='BCP_DARC_fixed', help='experiment_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = "/root/autodl-fs/BCP-main/code/model/BCP/ACDC_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
    test_save_path = "/root/autodl-fs/BCP-main/code/model/BCP/ACDC_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
